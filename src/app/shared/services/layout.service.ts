  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        sidebarColor: "prosuite-blue", // http://demos.ui-lib.com/egret-doc/#egret-colors
        sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
        dir: "ltr", // ltr, rtl
        useBreadcrumb: true,
        topbarFixed: false,
        footerFixed: false,
        topbarColor: "prosuite-blue", // http://demos.ui-lib.com/egret-doc/#egret-colors
        footerColor: "prosuite-blue", // http://demos.ui-lib.com/egret-doc/#egret-colors
        matTheme: "prosuite-blue", // egret-blue, egret-navy, egret-light-purple, egret-dark-purple, egret-dark-pink, prosuite-blue
