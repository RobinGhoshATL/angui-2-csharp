...
import { AppConfirmExecutionComponent } from '../services/app-confirm-execution/app-confirm-execution.component';
...
@NgModule({
  ...
  entryComponents: [AppComfirmComponent, AppLoaderComponent, AppConfirmExecutionComponent],
  exports: components
})
